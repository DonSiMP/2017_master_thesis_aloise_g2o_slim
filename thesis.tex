...
\def\state{\mathbf{x}}
\def\meas{\mathbf{z}}
\def\pred{\mathbf{\hat{z}}}
\def\linstate{\mathbf{\breve{\state}}}
\def\dx{\Delta \state}
\def\error{\mathbf{e}}
\def\jacob{\mathbf{J}}
...
\newpage
\input{chapters/1_related}
\newpage
\input{chapters/2_basics}
\newpage
\input{chapters/3_problems}
\newpage
\input{chapters/4_solvingSE3}
\newpage
\input{chapters/5_spsolver}
\newpage
\input{chapters/6_cases}
\newpage
