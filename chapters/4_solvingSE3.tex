...
The next step consists in applying both noise figures to the \textit{sphere} graph, together with a translational perturbation (therefore a 6DoF noise vector). 
%\vspace{15px}
